...
DEBUG = True
ALLOWED_HOSTS = [env("ALLOW_HOST"),env("LOCALHOST")]
...
INSTALLED_APPS = [
    ...
    "django.contrib.staticfiles",
     'django.contrib.humanize',  # For date formatting
    "cloudinary_storage",
    "cloudinary",
...
IS_PRODUCTION = env("ENVIRONMENT", default="development")
...
MIDDLEWARE = [
    ...
    "FIXENIX.middleware.WWWRedirectMiddleware",  # Add this line
...
if IS_PRODUCTION:  # Only add in production
    MIDDLEWARE.insert(0, 'FIXENIX.middleware.WWWRedirectMiddleware')
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'FIXENIX.context_processors.google_analytics',  # Add this line
            ],
                                    # ! New Line
            "libraries": {
