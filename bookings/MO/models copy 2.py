...
class RepairService(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Check if the instance already exists (i.e., it is not a new instance)
        if self.pk:
            # Fetch the original instance from the database
            original = RepairService.objects.get(pk=self.pk)
    ...
    def send_status_update_email(self):
        ...
        context = {
            ...
            'company_name': 'Fixenix eShop',  # Replace with your company name
            'company_contact': '+1-234-567-890',  # Replace with your contact number
            'company_website': 'https://www.fixenix.com',  # Replace with your website URL
            'terms_conditions_link': 'https://www.fixenix.com/terms-and-conditions'  # Replace with your terms & conditions link
        }
