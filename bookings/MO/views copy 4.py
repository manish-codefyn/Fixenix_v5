        ...
        if form.is_valid():
            ...
            if str(entered_otp) == str(session_otp):
                ...
                context = {
                    ...
                    'company_name': 'Fixenix eShop',
                    'company_contact': '+1-234-567-890',
                    'company_website': 'https://www.fixenix.com',
                    'terms_conditions_link': 'https://www.fixenix.com/terms-and-conditions'
                }
