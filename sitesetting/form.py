...
class StaffSitesForm(ModelForm):
     ...
     class Meta:
        ...
        'display_name','domain_name','app_email',
        'app_mobile','app_address','app_version',
        'app_logo','app_fevicon','app_stamp',
        ...
        widgets = {
            'display_name': TextInput(attrs={
               ...
               'domain_name': TextInput(attrs={
                ...
                'app_email': TextInput(attrs={
                'class': "form-control", 
                'style': 'max-width: 300px;',
                'placeholder': 'app email',
                'type':'email'
                }),
               'app_mobile': TextInput(attrs={
                'class': "form-control", 
                'style': 'max-width: 300px;',
                'placeholder': 'app mobile'
                }),
                'app_address': TextInput(attrs={
                'class': "form-control", 
                'style': 'max-width: 300px;',
                'placeholder': 'app address'
                }) ,
                 'app_version': TextInput(attrs={
                'class': "form-control", 
                'style': 'max-width: 300px;',
                'placeholder': 'app version',
                
                }), 
                 'app_logo': FileInput(attrs={
                'class': "form-control", 
                'style': 'max-width: 300px;',
