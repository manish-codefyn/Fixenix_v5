...
class FaqDelete(StaffRequiredMixin, TestMixinUserEmail, DeleteView):
    ...
    template_name = "dashboard/faq/list." + app_settings.TEMPLATE_EXTENSION
...
class FaqUpdate(StaffRequiredMixin, TestMixinUserEmail, UpdateView):
    ...
    template_name = "dashboard/faq/update." + app_settings.TEMPLATE_EXTENSION
    login_url = reverse_lazy("account_login")
    model = Faq
    success_url = reverse_lazy("dashboard:faq_list")
...
class FaqDetail(StaffRequiredMixin, TestMixinUserEmail, DetailView):
    ...
    template_name = "dashboard/faq/detail." + app_settings.TEMPLATE_EXTENSION
    model = Faq
    login_url = reverse_lazy("account_login")
    context_object_name = "faq"
    extra_context = {
...
class FaqCreate(StaffRequiredMixin, TestMixinUserEmail, CreateView):
    ...
    template_name = "dashboard/faq/Create." + app_settings.TEMPLATE_EXTENSION
    login_url = reverse_lazy("account_login")
    model = Faq
    form_class = FaqForm
    ...
    def get_success_url(self):
        ...
        return reverse("dashboard:faq_list")
