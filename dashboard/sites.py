...
class SitesDelete(StaffRequiredMixin, TestMixinUserEmail, DeleteView):
    ...
    model = Sites
    template_name = "dashboard/sites/list." + app_settings.TEMPLATE_EXTENSION
...
class SitesUpdate(StaffRequiredMixin, TestMixinUserEmail, UpdateView):
    ...
    template_name = "dashboard/sites/update." + app_settings.TEMPLATE_EXTENSION
    login_url = reverse_lazy("login")
...
class SitesCreate(StaffRequiredMixin, TestMixinUserEmail, CreateView):
    ...
    form_class = StaffSitesForm
    initial = {"key": "value"}
    template_name = "dashboard/sites/create." + app_settings.TEMPLATE_EXTENSION
    ...
    def get_success_url(self):
        ...
        return reverse("dashboard:site_list")
...
class SitesDetail(StaffRequiredMixin, TestMixinUserEmail, DetailView):
    ...
    model = Sites
    context_object_name = "sites"
    template_name = "dashboard/sites/detail." + app_settings.TEMPLATE_EXTENSION
    login_url = reverse_lazy("login")
    extra_context = {
        "app_data": Sites.objects.all(),
