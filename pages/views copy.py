...
class VerifyOtpView(View):
    ...
    def post(self, request):
        ...
        return render(request, 'pages/verify_otp.html', {'form': form,'otp_time': request.session.get('otp_time')})
...
class ContactFormView(View):
    ...
    def form_valid(self, form):
        ...
        from_mail = settings.EMAIL_HOST_USER
        to_mail = app_setting.EMAIL_CC
        template_name = "email/message." + app_setting.TEMPLATE_EXTENSION
...
class DisclamerView(TemplateView):
    ...
    extra_context = {
        "page_title": "disclamer |  Fixenix - Best Mobile Repair in Siliguri"
        }
...
class TermsAndConditionsView(TemplateView):
    ...
    extra_context = {
        "page_title": "Terms & Conditions | Fixenix - Best Mobile Repair in Siliguri"
        }
